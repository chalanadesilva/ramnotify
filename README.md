...
## Reqirements
Reqires python, and pip. install python from [python.org](python.org) and pip by running `python -m ensurepip --upgrade`\(windows\) or `python3 -m ensurepip --upgrade`\(macos and GNU/Linux\).
